...
/**
 * @function BPReport helps to represent the derived Blood Pressure
 * data (Systolic & Diastolic) form the Context in @constant currentPatient
 */

const BPReport = () => {
  const { currentPatient } = useContext(PatientContext);
  return (
    <div className="ml-6 lg:w-[35%]">
      <div>
